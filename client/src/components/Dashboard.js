  ...
  return (
    ...
    >
      <Grid container spacing={12}>
            ...
            <Grid item xs={5.5}>
            <Typography variant="h5" align="left" style={{font:"25px Montserrat, sans-serif"}}>
              <br></br>
              <br></br>
                <b>Highly Professional Doctors</b>
              </Typography>
              <Typography align="left" style={{font:"17px Montserrat, sans-serif"}}>
                <br></br>
                All specialists have practical experience and regularly training courses in educational centers of the world.
            </Typography>
            </Grid>
            <Grid item xs={2} align="left" classname="grid1">
              <div className="readmore" align="left">
              <Button style={{backgroundColor:'gray',borderColor:'white',marginTop:"25px"}} align="left">
                <div style={{font:"17px Montserrat, sans-serif",width:"120%",marginTop:"auto",marginBottom:"auto",marginLeft:"-8px",marginRight:"20px"}}>Read More </div> 
              </Button>
              </div>
    ...
    >
      <Typography variant="h5" align="center" style={{font:"25px Montserrat, sans-serif"}}>
              <br></br>
    ...
    >
      <Grid container spacing={12}>
            ...
            <Grid item xs={5}>
            <Typography variant="h5" align="center" style={{font:"23px Montserrat, sans-serif",color:"red"}}>
              <br></br>
                <b>BLOOD GROUPS</b>
              </Typography>
              <Typography align="left" style={{font:"15px Montserrat, sans-serif"}}>
                <br></br>
                Blood group of any human being will mainly fall in any one of the following groups...
                <br></br>
                <br></br>
                <li><b>A+ve or A-ve</b></li>
                <li><b>B+ve or B-ve</b></li>
                <li><b>O+ve or O-ve</b></li>
                <li><b>AB+ve or AB-ve</b></li>
            </Typography>
            <Typography align="left" style={{font:"15px Montserrat, sans-serif"}}>
                <br></br>
                ...
                <br></br>
                <br></br>
                <li><b>Iron -</b>  Meat, Eggs, Breads and Cereals, Fruits, Beans, Vegetables.</li>
                <br></br>
                <li><b>Vitamin C -</b> Citrus fruits, Kiwi, Mango, Papaya, Pineapple, etc.</li>
      ...
      <Grid container spacing={12}>
            ...
            <Grid item xs={3} align="left" classname="grid1">
              ...
              <br></br>
              <div className="readmore" align="left">
              <Button style={{backgroundColor:'black',borderColor:'white',width:"115%"}} align="left">
                <p className="donorbutton" style={{font:"17px Montserrat, sans-serif",marginTop:"3%",marginBottom:"3%"}}>Become a Donor</p>
              </Button>
              </div>
